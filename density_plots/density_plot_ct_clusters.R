...
for (k in 1:k_clust){
  ...
  scorepar <- BiDAG::scoreparameters("bdecat", mut_cov_data, weightvector = allrelativeprobabs)
...
pdf("~/Desktop/density_plot_ct_cluster.pdf", width = 9, height = 5, onefile=FALSE)
transparent_plot
dev.off()
